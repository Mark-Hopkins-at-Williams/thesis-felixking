...
from finetuning.configure import AMERICAS_NLP_CSV, AMERICAS_NLP_LPS # type: ignore
from finetuning.configure import NLLB_SEED_CSV, NLLB_SEED_LPS       # type: ignore
...
if __name__ == "__main__":
    ...
    csv_file = config['parallel_corpus_file']
