...
SEED_EMBED_PICKLE = '/mnt/storage/fking/data/seed/nllb_seed_with_embeddings.pkl'
...
TEN_SEED_LANGS  = ['pbt_Arab', 'bho_Deva', 'nus_Latn', 'dzo_Tibt', 'mni_Beng', 'lim_Latn', 
                   'ltg_Latn', 'ace_Latn', 'eng_Latn', 'knc_Arab']
